...
initNode :: (MonadBaseConstr t m, MonadSettings t m)
  => Currency
  -> NodeReqSelector t
...
initializeNodes :: (MonadBaseConstr t m, MonadSettings t m)
  => NodeReqSelector t
...
reinitNodes :: forall t m . (MonadBaseConstr t m, MonadSettings t m)
