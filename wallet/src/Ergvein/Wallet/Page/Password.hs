...
passwordPage mnemonic curs = wrapperSimple  $ do
...
setupLoginPage m ac = wrapperSimple  $ do
...
setupPatternPage m l curs = wrapperSimple  $ do
...
askPasswordPage name = wrapperSimple  $ do
